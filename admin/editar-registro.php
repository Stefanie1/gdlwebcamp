                                                            ...
                                                            <li class="col-md-4">
                                                                    <div class="tabla-precio">
                                                                        ...
                                                                        <div class="orden">
                                                                            ...
                                                                            <input type="number" min="0" id="pase_dia" size="3" name="boletos[un dia][cantidad]" placeholder="0" value="<?php echo $boletos['un dia']['cantidad']; ?>">
                                                                            <input type="hidden" value="30" name="boletos[undia][precio]">
                                                                        </div>
                                                                    </div>
                                                            </li>
                                                            <li class="col-md-4">
                                                                        ...
                                                                        <?php foreach($eventos['eventos'] as $tipo => $evento_dia):  ?>
                                                                                        ...
                                                                                        <div class="col-md-4">
                                                                                            ...
                                                                                            foreach($evento_dia as $evento):  ?>
                                                                                                ...
                                                                                                <label>
                                                                                                    <input <?php echo (in_array($evento['id'], $id_eventos_registrados['eventos']) ? 'checked' : ''  )  ?>  type="checkbox" name="registro_evento[]" value="<?php echo $evento['id'] ?>" >
