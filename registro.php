    ...
    <section class="seccion contenedor">
        ...
        <form id="registro" class="registro" action="pagar.php" method="post">
            ...
            <div id="paquetes" class="paquetes">
                <h3>Elige el numero de voletos</h3>
                    ...
                    <li>
                        <div class="tabla-precio">
                            ...
                            <div class="orden">
                                ...
                                <input type="numer" min="0" id="pase_dia" size="3" name="boletos[un_dia][cantidad]" placeholder="0">
                    ...
                    <li>
                        <div class="tabla-precio">
                            ...
                            <div class="orden">
                                ...
                                <input type="numer" min="0" id="pase_completo" size="3" name="boletos[completo][cantidad]" placeholder="0">
                    ...
                    <li>
                        <div class="tabla-precio">
                            ...
                            <div class="orden">
                                ...
                                <input type="numer" min="0" id="pase_dosdias" size="3" name="boletos[2dias][cantidad]" placeholder="0">
